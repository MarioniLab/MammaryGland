...
First, we dissected the global structure in the dataset by unsupervised clustering using a shared-nearest-neighbour community clustering approach.
This identified 13 groups, which still contained evident substructure as visualized by t-SNE (SupX).
Hence, we used hierarchical clustering on each of the identify groups to further resolve the cellular heterogeneity.
This identified a total of 15 clusters of epithelial cells (\autoref{F1}c, SupX).
...
Lp expresses high levels of the luminal progenitor marker \textit{Aldh1a3} suggesting progenitor function, while Hsp and Avp also show expression of progenitor markers but to a lesser extent.
