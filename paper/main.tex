...
Another group of cluster appeared to be less differentiated and expressed genes associated with basal progenitor cells (Bsl) (\textbf{Examples and Citation}).
...
Clusters 6.1 and 6.2 were tagged as immune cells based on the expression of \textit{Cd74}, \textit{Cd72} and \textit{Cd54}\autocite{Scheele2017} and cluster 10.3 as endothelial cells based on the expression of \textit{Eng}, \textit{S1pr1} and \textit{Emcn} (Supplementary Figure 4c, Supplementary Figure 4d).
We retained cluster 10.2 as it expressed markers of a previously described celltype in the gland\autocite{Wang2015}, despite being positive for 2 out of 4 (\textit{Des} and \textit{Cspg4}) pericyte markers\autocite{Armulik2011} (Supplementary Figure 4e).
